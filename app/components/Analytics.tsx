  ...
  return (
    <div className="space-y-6 md:space-y-8 animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        {/* Radar Chart Section */}
        <div className="bg-[#F8F9FD] dark:bg-dark-nav border border-transparent dark:border-white/5 rounded-[24px] p-4 md:p-8 flex flex-col shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
        ...
        <div className="space-y-4">
          <div className="bg-[#F8F9FD] dark:bg-dark-nav border border-transparent dark:border-white/5 rounded-[24px] p-6 md:p-8 relative overflow-hidden shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
          ...
          <div className="bg-black dark:bg-white text-white dark:text-black p-6 md:p-8 rounded-[24px] shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
