  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 animate-fade-in-up">
      <header className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 pb-6">
        ...
        <button 
            onClick={onBack}
            className="px-6 py-2 bg-gray-100 dark:bg-white/10 hover:bg-gray-200 dark:hover:bg-white/20 text-gray-900 dark:text-white rounded-xl text-sm font-bold transition-colors"
        >
            Return to Dashboard
        </button>
      </header>
      ...
      <div className="bg-black dark:bg-white text-white dark:text-black rounded-2xl p-8 shadow-lg">
          <div className="flex flex-col md:flex-row gap-8 items-start">
             ...
             <div className="flex-shrink-0">
                 <button onClick={onBack} className="px-6 py-3 bg-white dark:bg-black text-black dark:text-white rounded-xl text-sm font-bold hover:scale-105 transition-transform shadow-md">
                     Continue Training
                 </button>
             </div>
          </div>
