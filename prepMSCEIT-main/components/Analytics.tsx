  ...
  return (
    <div className="space-y-6 md:space-y-8 animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        {/* Radar Chart Section */}
        <div className="bg-[#F8F9FD] dark:bg-[#0A0A0A] border border-transparent dark:border-white/5 rounded-xl p-4 md:p-8 flex flex-col shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
        ...
        <div className="space-y-4">
            <div className="bg-[#F8F9FD] dark:bg-[#0A0A0A] border border-transparent dark:border-white/5 rounded-xl p-6 md:p-8 relative overflow-hidden shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
             ...
             <div className="bg-black dark:bg-white text-white dark:text-black p-6 md:p-8 rounded-xl shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                ...
                <ul className="space-y-3">
                    <li className="flex gap-4 items-center border border-white/10 dark:border-black/10 bg-white/5 dark:bg-black/5 p-4 rounded-xl hover:bg-white/10 dark:hover:bg-black/10 transition-colors cursor-pointer group">
                        ...
                        <span className="font-medium text-sm text-gray-200 dark:text-gray-700 group-hover:text-white dark:group-hover:text-black">Launch "Conflict De-escalation" scenario.</span>
                    </li>
                    <li className="flex gap-4 items-center border border-white/10 dark:border-black/10 bg-white/5 dark:bg-black/5 p-4 rounded-xl hover:bg-white/10 dark:hover:bg-black/10 transition-colors cursor-pointer group">
